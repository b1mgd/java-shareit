...
public class RequestServiceImpl implements RequestService {
    ...
    public RequestDto createRequest(PostRequestDto request, long requestorId) {
        ...
        RequestDto result = requestMapper.mapToRequestDto(requestRepository.save(itemRequest));
        log.info("Запрос на предмет сохранен: {}", result);
    ...
    private void validateRequestor(long requestorId) {
        boolean exists = requestRepository.existsById(requestorId);
